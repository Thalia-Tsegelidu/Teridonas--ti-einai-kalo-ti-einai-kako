...
var AppClientLanguage = "DE";

addAppClientTranslation("DE",
                        "APPCLIENT_CHARACTERS","abcdefghijklmnopqrstuvwxyzäöü");
addAppClientTranslation("DE",
                        "APPCLIENT_FULLSCREEN","App im Vollbild anzeigen");
addAppClientTranslation("DE",
                        "APPCLIENT_HINTLINK","Aufgabe anzeigen");
addAppClientTranslation("DE",
                        "APPCLIENT_HELPLINK","Hilfe anzeigen");
addAppClientTranslation("DE",
                        "APPCLIENT_HELPDESCRIPTION","Hilfestellung");
addAppClientTranslation("DE",
                        "APPCLIENT_TASKDESCRIPTION","Aufgabe");
addAppClientTranslation("DE",
                        "APPCLIENT_GIVEPARAM","Geben Sie den Wert des Parameters ein:");
addAppClientTranslation("DE",
                        "APPCLIENT_CONNECTIONLOST","Die Verbindung zum App Server wurde unterbrochen. Eine neue Verbindung wird aufgebaut.");

addAppClientTranslation("DE",
                        "APPCLIENT_VIDEODELTED","Das Video ist noch nicht oder nicht mehr bei YouTube verfügbar.");
addAppClientTranslation("DE",
                        "APPCLIENT_VIDEOFORBIDDEN","Der Autor hat auf YouTube verboten, dieses Audio/Video in andere Webseiten einzubetten.");
addAppClientTranslation("DE",
                        "APPCLIENT_VIDEOWRONGURL","YouTube-URL ist ungültig.");

addAppClientTranslation("DE",
                        "APPCLIENT_READSPEECH","vorlesen");
